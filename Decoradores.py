#ahora, un decorador es una funcion que recibe como parametro otra funcion, la modifica, la ejecuta 
# y retorna esta misma función, pero diferente, aqui un ejemplo 
